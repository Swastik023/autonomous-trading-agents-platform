# Autonomous Multi-Agent Financial Trading & Market Intelligence Platform

> **Engineer:** Swastik Agnihotri  
> **Contact / Professional Git Identity:** `Swastik Agnihotri <swastikwork007@gmail.com>`  
> **GitHub:** [Swastik023/autonomous-trading-agents-platform](https://github.com/Swastik023/autonomous-trading-agents-platform)  
> **Architecture:** LangGraph Cyclical Multi-Agent State Machine · Multi-Vendor Financial Dataflows · OPA Risk Governance  
...
The system ingests real-time and historical market data from multi-vendor financial feeds (Yahoo Finance, Alpha Vantage, FRED, SEC EDGAR, Reddit, StockTwits), evaluates risk-adjusted trading opportunities, executes multi-agent debate protocols, and produces deterministic portfolio backtesting simulations.
...
```bash
SEC_EDGAR_USER_AGENT="Your Name swastikwork007@gmail.com"
```
